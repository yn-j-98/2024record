...
<body>
   ...
   <script>
      $(document).ready(function() {
            $("#uploadPhoto").click(function(event) { // 모달창에 있는 업로드 버튼을 눌렀을 때의 함수
   ...
   <div class="container pt-3">
         ...
         <div class="page-inner">
            ...
            <form action="CHANGEMEMBERACTION.do" method="post" enctype="multipart/form-data">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col-md-2 d-flex align-items-center">
                        ...
                        <input type="hidden" name="member_id" value="${data.member_name}" />
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-2 d-flex align-items-center">
                     ...
                     <div class="col-md-10">
                        <div class="form-group">
                           <input type="text" class="form-control" id="phone" name="member-phone"
                              value="${data.member_phone}" placeholder="전화번호를 입력해주세요" />
                        </div>
                     </div>
                  </div>
                  <div class="row">
            ...
            <div class="modal-dialog" role="document">
               <div class="modal-content">
                  ...
                  <div class="modal-body">
                     <form>
                        <div class="form-group">
                           <label for="photoUpload">새 프로필 사진 업로드</label> <input
                              type="file" class="form-control-file" id="photoUpload"
                              name="photoUpload">
                        </div>
                        <div class="form-group">
