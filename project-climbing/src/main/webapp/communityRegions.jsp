		    ...
		    if (prev > 0) {
		        ...
		        if(board_list != null){
			         preli.insertAdjacentHTML("beforeend",
			        	    "<a id='allprev' class='page-link' href='MainCommunityPage.do?page=" + prev + "&VIEW_BOARD_LIST="+VIEW_BOARD_LIST+"&VIEW_BOARD_KEYWORD="+VIEW_BOARD_KEYWORD+"' aria-label='Previous'>" + 
		    ...
		    for (let i = first; i <= last; i++) {
		        ...
		        if(board_list != null){
			        li.insertAdjacentHTML("beforeend",
			        	    "<a class='page-link m-2' href='MainCommunityPage.do?page=" + i + "&VIEW_BOARD_LIST="+VIEW_BOARD_LIST+"&VIEW_BOARD_KEYWORD="+VIEW_BOARD_KEYWORD+"' id='page-" + i + "' data-num='" + i + "'>" +
			        	    i +
			        	    "</a>"
			        	);
		    ...
		    if (last < totalPage) {
		        ...
		        if(board_list != null){
			        endli.insertAdjacentHTML("beforeend",
			        	    "<a class='page-link' href='MainCommunityPage.do?page=" + next + "&VIEW_BOARD_LIST="+VIEW_BOARD_LIST+"&VIEW_BOARD_KEYWORD="+VIEW_BOARD_KEYWORD+"' id='allnext' aria-label='Next'>" + 
