	...
	<div class="container">
					            ...
					            <div class="card card-stats card-round pt-3 px-5 pb-5">
					                <div class="row">
					                    <div class="col-md-3 text-center">
					                        <img src="${model_crew_board_data.model_crew_board_member_profile}" class="avatar-img rounded-circle form-group" alt="작성자 사진"> ${model_crew_board_data.model_crew_board_writer_id}
					                    </div>
					                ...
					                <div class="row">
					                    ...
					                    <div class="col-md-7">${model_crew_board_data.model_crew_board_content}</div>
					                </div>
					            </div>
					        </div>
					        <% cnt++; %>
	    ...
	    function updatePostList(model_crew_board_datas) {
	        ...
	        $.each(model_crew_board_datas, function(index, post) {
	            ...
	            postsHtml += '<div class="col-md-12 mb-2">' +
	            '<div class="card card-stats card-round pt-3 px-5 pb-5">' +
	            '<div class="row">' +
	                '<div class="col-md-3 text-center">' +
	                    '<img src="' + profile + '" class="avatar-img rounded-circle form-group" alt="작성자 사진"> ' + writer +
	                '</div>' +
	                '<div class="col-md-2 d-flex align-items-center justify-content-center">' +
	                    '<h6>글 제목</h6>' +
	                '</div>' +
