...
public class BoardDAO {
   ...
   public boolean insert(BoardDTO boardDTO) {
      ...
      try {
         ...
         pstmt.setString(1,boardDTO.getBoard_title().replace("'", "\'"));
         pstmt.setString(2,boardDTO.getBoard_content().replace("'", "\'"));
   ...
   public boolean update(BoardDTO boardDTO) {
      ...
      try {
         ...
         if(boardDTO.getBoard_condition().equals("BOARD_UPDATE_CONTENT_TITLE")) {
            ...
            pstmt.setString(1, boardDTO.getBoard_content().replace("'", "\'"));
            pstmt.setString(2, boardDTO.getBoard_title().replace("'", "\'"));
   ...
   public BoardDTO selectOne(BoardDTO boardDTO) {
      ...
      try {
         ...
         //ID로 검색한 글 개수 BOARD_WRITER_ID
            ...
            pstmt.setString(1, boardDTO.getBoard_searchKeyword().replace("'", "\'"));
            sqlq = "count";
         }
         //제목으로 검색한 글 개수 BOARD_TITLE
   ...
   public ArrayList<BoardDTO> selectAll(BoardDTO boardDTO){
      ...
      try {
         //똑같은 ID로 검색 페이지네이션 윈도우함수 ROW_NUMBER()사용 BOARD_WRITER_ID, board_min_num, board_max_num
         if(boardDTO.getBoard_condition().equals("BOARD_ALL_SEARCH_MATCH_ID")) {
         ...
         //비슷한 ID로 검색 페이지네이션 윈도우함수 ROW_NUMBER()사용 BOARD_WRITER_ID, board_min_num, board_max_num
         else if(boardDTO.getBoard_condition().equals("BOARD_ALL_SEARCH_PATTERN_ID")) {
